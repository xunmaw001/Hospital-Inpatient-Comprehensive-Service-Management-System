          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护工编号" prop="hugongbianhao">
          <el-input v-model="ruleForm.hugongbianhao" 
              placeholder="护工编号" clearable  :readonly="ro.hugongbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护工编号" prop="hugongbianhao">
              <el-input v-model="ruleForm.hugongbianhao" 
          ...
          <el-form-item class="input" label="服务价格" prop="fuwujiage">
              <el-input v-model="ruleForm.fuwujiage" 
                placeholder="服务价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务天数" prop="fuwutianshu">
          <el-input v-model="ruleForm.fuwutianshu" 
              placeholder="服务天数" clearable  :readonly="ro.fuwutianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务天数" prop="fuwutianshu">
              <el-input v-model="ruleForm.fuwutianshu" 
                placeholder="服务天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                    zongjine:{
                                                                                                                                                          get: function () {
        return 1*this.ruleForm.fuwujiage*this.ruleForm.fuwutianshu
      }
    },
                                      },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='hugongbianhao'){
            this.ruleForm.hugongbianhao = obj[o];
	    this.ro.hugongbianhao = true;
            continue;
          }
	            	            if(o=='hugongxingming'){
	    ...
	    this.ro.fuwujiage = true;
            continue;
	            	            ...
	            	            if(o=='fuwutianshu'){
            this.ruleForm.fuwutianshu = obj[o];
	    this.ro.fuwutianshu = true;
            continue;
          }
	            	            if(o=='zongjine'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `hugongyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hugongyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
