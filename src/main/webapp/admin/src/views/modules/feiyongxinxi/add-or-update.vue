          ...
          <el-form-item class="input" label="费用名称" prop="feiyongmingcheng">
              <el-input v-model="ruleForm.feiyongmingcheng" 
                placeholder="费用名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="费用类型" prop="feiyongleixing">
          <el-select v-model="ruleForm.feiyongleixing" placeholder="请选择费用类型">
            <el-option
                v-for="(item,index) in feiyongleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" v-if="ruleForm.shijian" label="时间" prop="shijian">
              <el-input v-model="ruleForm.shijian" 
                placeholder="时间" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="费用明细" prop="feiyongmingxi">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.feiyongmingxi" label="费用明细" prop="feiyongmingxi">
                    <span v-html="ruleForm.feiyongmingxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.feiyongmingxi = this.ruleForm.feiyongmingxi.replace(reg,'../../../ssm11719/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
