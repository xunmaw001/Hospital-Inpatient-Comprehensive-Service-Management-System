<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护工号" prop="hugonghao">
          <el-input v-model="ruleForm.hugonghao" 
              placeholder="护工号" clearable  :readonly="ro.hugonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护工号" prop="hugonghao">
              <el-input v-model="ruleForm.hugonghao" 
                placeholder="护工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
            ...
            ruleForm: {
                	        hugonghao: '',
	                        	        ...
	                        	        tupian: '',
                                                              ...
                                                              rules: {
                  hugonghao: [
                            { required: true, message: '护工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='hugonghao'){
            this.ruleForm.hugonghao = obj[o];
	    this.ro.hugonghao = true;
            continue;
          }
	            	            if(o=='mima'){
