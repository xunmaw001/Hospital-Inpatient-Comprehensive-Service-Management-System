  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 0, 29, 0.73);fontSize:28px;">医院住院综合服务管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='yisheng'" class="input-group">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			   ...
			   <div class="label">护工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.hugonghao" class="input" type="text" placeholder="护工号">
			   </div>
			 </div> -->
			<el-form-item label="护工号" class="input" v-if="tableName=='hugong'">
			  <el-input v-model="ruleForm.hugonghao" autocomplete="off" placeholder="护工号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='hugong'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='hugong'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='hugong'" class="input-group">
			   <div class="label">年龄</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='hugong'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming) && `yisheng` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
        ...
        return
                                                                                                                        ...
                                                                                                                        if((!this.ruleForm.hugonghao) && `hugong` == this.tableName){
        this.$message.error(`护工号不能为空`);
        return
      }
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming) && `hugong` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
        ...
        return
                                                                                    ...
                                                                                    if(`hugong` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                                                                                                                                                                  this.$http({
