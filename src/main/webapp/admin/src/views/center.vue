     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yisheng'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
                                          ...
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item v-if="flag=='yisheng'" label="图片" prop="tupian">
          ...
          ></file-upload>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='hugong'"  label="护工号" prop="hugonghao">
          <el-input v-model="ruleForm.hugonghao" readonly              placeholder="护工号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='hugong'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='hugong'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='hugong'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="flag=='hugong'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tupian?ruleForm.tupian:''"
          @change="hugongtupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.tupian = fileUrls;
                                                                                ...
                                                                                hugongtupianUploadChange(fileUrls) {
        this.ruleForm.tupian = fileUrls;
    },
                                                                                            onUpdateHandler() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming)&& 'yisheng'==this.flag){
        this.$message.error('姓名不能为空');
        return
      }
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                                                                        ...
                                                                                                                        if((!this.ruleForm.hugonghao)&& 'hugong'==this.flag){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming)&& 'hugong'==this.flag){
        this.$message.error('姓名不能为空');
        return
      }
       ...
       this.$message.error(`年龄应输入整数`);
        return
                                                                                    ...
                                                                                    if( 'hugong' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                                                                                                                                                                  this.$http({
